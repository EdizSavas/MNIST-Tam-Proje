...
class DigitRecognizer(QWidget):
    def save_example(self):
        ...
        if not label_text.isdigit() or not (0 <= int(label_text) <= 9):
            ...
            self.info_label.setText("")  # Hata varsa alt mesajı boşalt
            return
        ...
        self.result_label.setText(f"{label_text} olarak veri kaydedildi.")
        self.info_label.setText(f"Toplam veri: {index}")
        self.canvas.clear()
    ...
    def __init__(self):
        ...
        layout.addWidget(self.info_label)  # Bu satır yeni
